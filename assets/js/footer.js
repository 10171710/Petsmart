    ...
    <div class="pv-container">
      <div class="row g-4">
        <div class="col-lg-4 col-md-6">
          ...
          <p class="mb-0 text-secondary"><i class="fa-solid fa-paw"></i> Certified &amp; insured · Loving pet care since 2012</p>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <div class="mt-4 d-flex flex-column gap-2 text-secondary">
            <span><i class="fa-solid fa-location-dot"></i> 24 Wagtail Lane, Pet District</span>
            <span><i class="fa-solid fa-phone"></i> +1 (555) 012-3456</span>
            <span><i class="fa-solid fa-envelope"></i> hello@pawville.com</span>
          </div>
        </div>
      </div>

      <div class="footer-bottom d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
        <span>© <span id="year">2025</span> PawVille. Crafted with <i class="fa-solid fa-heart"></i> for pets &amp; their humans.</span>
      ...
      host.querySelectorAll("[data-policy]").forEach(function (a) {
        a.addEventListener("click", function (e) {
          ...
          if (p && window.PawPopup) {
            PawPopup({ icon: '<i class="fa-solid fa-paw"></i>', title: p.title, content: p.body, wide: true });
          }
        });
      });
    }
