...
(function () {
  ...
  var MAYA = { name: "Maya Torres", role: "Master Groomer", avatar: "assets/images/ava-blog-maya.jpg", bio: "14 years grooming, 200+ breeds and a lifelong believer that kindness is the most important tool in any salon." };
  var OMAR = { name: "Omar Khaled", role: "Cat Care Specialist", avatar: "assets/images/ava-blog-omar.jpg", bio: "PawVille's resident cat whisperer. Studied feline behaviour and spends his days making cats fall in love with grooming." };
  var SOFIA = { name: "Sofia Reyes", role: "Salon Manager", avatar: "assets/images/ava-blog-sofia.jpg", bio: "Runs the salon floor, trains new groomers and keeps everything running smooth — one paw at a time." };
  var NOAH = { name: "Noah Bennett", role: "Nutrition Consultant", avatar: "assets/images/ava-blog-noah.jpg", bio: "Pet nutrition nerd who believes great coats start with great food — and a good groomer." };
