...
(function () {
  ...
  <aside class="admin-sidebar" id="admin-sidebar">
    ...
    <nav class="flex-grow-1">
      ...
      <ul class="nav flex-column">
        <li class="nav-item"><a class="nav-link" href="../index.html"><span class="nav-ico">🌐</span> View Website</a></li>
        <li class="nav-item"><a class="nav-link" href="../admin/index.html"><span class="nav-ico">🛠️</span> Admin Portal</a></li>
      </ul>
    </nav>

    <div class="clay-inset p-3 mt-3">
      <div class="d-flex align-items-center gap-3">
        <div class="clay-avatar sm" style="display:flex;align-items:center;justify-content:center;font-weight:800;font-size:1rem" id="side-avatar">P</div>
        ...
        <a href="#" data-logout title="Log out" class="nav-icon-btn" style="width:34px;height:34px">⏻</a>
      </div>
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
      ...
      <div class="dropdown">
        <a href="#" class="d-flex align-items-center gap-2 text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="clay-avatar sm" style="display:flex;align-items:center;justify-content:center;font-weight:800;color:var(--pv-primary);font-size:1rem" id="top-avatar">P</div>
          <span class="fw-bold d-none d-lg-inline" id="top-name" style="color:var(--pv-text)">Pet Parent</span>
        </a>
  ...
  function inject() {
    ...
    if (s) {
      ...
      var initial = name.trim().charAt(0).toUpperCase() || "P";
      var n1 = document.getElementById("side-name");
      var n2 = document.getElementById("top-name");
      var a1 = document.getElementById("side-avatar");
      var a2 = document.getElementById("top-avatar");
  ...
  function renderStats() {
    ...
    set("stat-points", done.length * 10);
  }
  ...
  function appointmentRow(a) {
    ...
    if (a.status === "completed") {
      actions = '<button class="btn-clay btn-sm" data-invoice="' + a.id + '">🧾 Invoice</button>';
    } else if (a.status === "cancelled") {
      actions = '<button class="btn-clay-outline btn-sm" data-action="delete">🗑 Remove</button>';
    } else {
      actions = '<button class="btn-clay-outline btn-sm text-danger" data-action="cancel">✕ Cancel</button>';
    }
    return (
      '<tr data-id="' + a.id + '">' +
      ...
      ? done.map(function (a) {
          return (
            '<tr>' +
              ...
              '<td>' + a.date + '</td>' +
              '<td>' + statusBadge(a.status) + '</td>' +
              '<td class="text-end"><button class="btn-clay btn-sm" data-invoice="' + a.id + '">🧾 View Invoice</button></td>' +
            '</tr>'
          );
        }).join("")
