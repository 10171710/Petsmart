...
(function () {
  ...
  <nav class="navbar navbar-expand-lg fixed-top pv-navbar">
    <div class="pv-container w-100 d-flex align-items-center gap-2">
      ...
      <a class="navbar-brand me-auto me-lg-3" href="index.html">
        <img src="${LOGO}" alt="PawVille logo">
        <span>PawVille</span>
      </a>

      <div class="collapse navbar-collapse" id="pvMainNav">
      ...
      <div class="d-flex align-items-center gap-2 order-lg-last ms-lg-3">
        ...
        <a class="btn-clay btn-sm d-none d-lg-inline-flex" href="pricing.html">Book Now</a>
      </div>
    </div>
  </nav>
  `;
